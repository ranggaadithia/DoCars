...
@section('container')
  ...
  @include('components.navbar')
    ...
    <div class="d-show h-100 bg-white" style="overflow: hidden">
      <img src="{{ asset('storage/'. $package->image) }}" alt="" class="img-fluid w-100 h-100" style="object-fit: cover">
  ...
  <div class="container mb-5">
    <h1 class="text-center mb-5 pt-3" data-aos="fade-up">Itinerary</h1>
